...
public class PlanteAdapter extends BaseAdapter {
    private List<Plante> objects;
    private LayoutInflater inflater;

    public PlanteAdapter(Activity activity, List<Plante> objects) {
        this.objects = objects;
        inflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

    }

    public List<Plante> getObjects() {
        return objects;
    }


    public PlanteAdapter(StatisticActivity activity) {
        this.objects = new ArrayList<Plante>();
        inflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide
                ...
                .into(photo);
        Log.d("test", "getView: " + objects.get(position).getImage());
        return convertView;
    }

    public void setObjects(List<Plante> plantes) {

        this.objects=plantes;
